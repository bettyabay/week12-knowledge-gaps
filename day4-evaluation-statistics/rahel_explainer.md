...
*Written by Rahel Samson for Bethelhem Abay, whose `ablation_results.json` reports 85.2% held-out accuracy (52/61 correct) with 95% CI [0.77, 0.93] computed using the Wald (normal approximation) formula.*
...
The Wald CI Bethelhem reported ([0.77, 0.93]) rounds from [0.763, 0.941] — confirmed correct.
